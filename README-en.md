...
If the Claude CLI is unavailable or registration fails, the installer writes a `.mcp.json` fallback in the plugin directory. Restart Claude Code and approve `codex-subagent` when prompted.
